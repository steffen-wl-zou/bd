...

{
    ...
    origin_country_location_id = readline(prompt = "Enter origin country location ID: ")
    
    # prompt for location id of country
    destination_country_location_id = readline(prompt = "Enter destination country location ID: ")
    ...
    # call API
    api_url = paste0("https://developer.bluedot.global/travel/air/?originLocationIds=", origin_country_location_id, 
                     "&destinationLocationIds=", destination_country_location_id, 
                     "&originAggregationType=6&destinationAggregationType=6&startDate=", 
    ...
    output_filename = paste0(start_date_input, "_to_", end_date_input, "_location_id_", origin_country_location_id, "_to_", destination_country_location_id,".csv")
