...

{
    ...
    destination_country_location_id = readline(prompt = "Enter location ID of country: ")
    ...
    # call API
    api_url = paste0("https://developer.bluedot.global/travel/air/?originLocationIds=&destinationLocationIds=", destination_country_location_id,"&originAggregationType=6&destinationAggregationType=6&startDate=", 
